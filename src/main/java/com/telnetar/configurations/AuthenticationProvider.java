...
public class AuthenticationProvider {
	...
	public UserDetailsService userDetailsService(){
		...
		jdbcImpl.setUsersByUsernameQuery("select a.username,a.password,a.enabled from sso.users a, sso.user_systems b where a.pk = b.pk_user and b.pk = 1 and a.username=?");
